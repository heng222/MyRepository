...
#define BLOCTRGZONE_AXLESGM_MAX_NUM               16                                                           /*包含计轴区段的最大数目*/
#define BLOCTRGZONE_LINE_BYTE_NUM                 36                                                        /*一行数据的字节数*/
...
typedef struct BnfBlocTrgZoneStruct
{
    ...
    UINT16_S  includeAxleSgmtId[BLOCTRGZONE_AXLESGM_MAX_NUM];                /*包含的计轴区段编号*/
