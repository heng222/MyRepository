...
******************************************************************************/
/*定义USR发送倒机数据信息注册函数*/
typedef void (*F_TrackDataGet)(unsigned char* inBuffAddr, unsigned int inBuffLen, unsigned int* outSendLen);

/*定义USR接收倒机数据信息注册函数*/
typedef void (*F_TrackDataSet)(unsigned char* inBuffAddr, unsigned int inRecvLen);
