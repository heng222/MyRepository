...
/*	m_ctrlStation.ResetContent();
	...
	for(int i=0; i<theApp.m_strlName[0].GetCount();i++)
	{
		m_ctrlStation.AddString(theApp.m_strlName[0].GetAt(theApp.m_strlName[0].FindIndex(i)));
	}
*/
	m_ctrlStation.AddString(CReadStationInf::GetInstance()->GetName(CReadStationInf::GetActiveStation()));
