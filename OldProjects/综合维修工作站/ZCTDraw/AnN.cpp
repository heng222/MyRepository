...
#define QT_BTN_CLR1			LIGHTBLUE      /* button (except LieChe|DiaoChe|DanCha) color */
#define QT_BTN_CLR2			DARKGRAY             /* button (except LieChe|DiaoChe|DanCha) color */
...
BOOL CAnN::PtInDevice(CDC* pDC, CPoint pt,int iDeviceType)
{
	if (iDeviceType==DT_SELF) {
		CRect rectDevice = CRect(m_pt.x,m_pt.y,m_pt.x+AN_WIDTH,m_pt.y+AN_HEIGHT);
