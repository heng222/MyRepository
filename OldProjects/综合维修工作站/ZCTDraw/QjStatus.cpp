...
BOOL CQjStatus::PtInDevice(CDC* pDC,CPoint pt,int iDeviceType)
{
	CRect rectDevice=CRect(m_pt.x,m_pt.y-QJLIGHTRADIUS,
		m_pt.x+QJLIGHTRADIUS*2,m_pt.y+QJLIGHTRADIUS);
