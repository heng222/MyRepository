...
BOOL CAdoRecordSet::Open(LPCTSTR strSQL, long lOption, CursorTypeEnum CursorType, LockTypeEnum LockType)
{
	...
	{
		XTRACE(_T("Warning: 打开记录集发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		XTRACE(_T("%s\r\n"), GetLastError());
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Requery(long Options)
{
	...
	{
		XTRACE(_T("Warning: Requery 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::Resync(AffectEnum AffectRecords, ResyncEnum ResyncValues)
{
	...
	{
		XTRACE(_T("Warning: Resync 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::Save(LPCTSTR strFileName, PersistFormatEnum PersistFormat)
{
	...
	{
		XTRACE(_T("Warning: Save 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::Load(LPCTSTR strFileName)
{
	...
	{
		XTRACE(_T("Warning: Load 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Cancel()
{
	...
	{
		XTRACE(_T("Warning: Cancel发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
void CAdoRecordSet::Close()
{
	...
	{
		XTRACE(_T("Warning: 关闭记录集发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
	}
}
...
BOOL CAdoRecordSet::AddNew()
{
	...
	{
		XTRACE(_T("Warning: AddNew 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::Update()
{
	...
	{
		XTRACE(_T("Warning: Update 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
	}
...
BOOL CAdoRecordSet::UpdateBatch(AffectEnum AffectRecords)
{
	...
	{
		XTRACE(_T("Warning: UpdateBatch 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE; 
}
...
BOOL CAdoRecordSet::CancelUpdate()
{
	...
	{
		XTRACE(_T("Warning: CancelUpdate 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::CancelBatch(AffectEnum AffectRecords)
{
	...
	{
		XTRACE(_T("Warning: CancelBatch 发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::Delete(AffectEnum AffectRecords)
{
	...
	{
		XTRACE(_T("Warning: Delete发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MoveFirst()
{
	...
	{
		//XTRACE(_T("Warning: MoveFirst 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MoveLast()
{
	...
	{
		XTRACE(_T("Warning: MoveLast 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::MovePrevious()
{
	...
	{
		XTRACE(_T("Warning: MovePrevious 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
	return FALSE;	
}
...
BOOL CAdoRecordSet::MoveNext()
{
	...
	{
		XTRACE(_T("Warning: MoveNext 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::Move(long lRecords, _variant_t Start)
{
	...
	{
		XTRACE(_T("Warning: Move 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
long CAdoRecordSet::GetState()
{
	...
	{
		XTRACE(_T("Warning: GetState 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	} 
	return -1;
}
...
BOOL CAdoRecordSet::IsOpen()
{
	...
	{
		XTRACE(_T("Warning: IsOpen方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
long CAdoRecordSet::GetStatus()
{
	...
	{
		XTRACE(_T("Warning: GetStatus 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	} 
	return -1;
}
...
long CAdoRecordSet::GetRecordCount()
{
	...
	{
		XTRACE(_T("Warning: GetRecordCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	} 
}
...
long CAdoRecordSet::GetFieldsCount()
{
	...
	{
		XTRACE(_T("Warning: GetFieldsCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	} 
}
/*========================================================================
...
long CAdoRecordSet::GetMaxRecordCount()
{
	...
	{
		XTRACE(_T("Warning: GetMaxRecordCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::IsBOF()
{
	...
	{
		XTRACE(_T("Warning: IsBOF 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return FALSE;
}
...
BOOL CAdoRecordSet::IsEOF()
{
	...
	{
		XTRACE(_T("Warning: IsEOF 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetPageCount()
{
	...
	{
		XTRACE(_T("Warning: GetPageCount 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCacheSize(const long &lCacheSize)
{
	...
	{
		XTRACE(_T("Warning: SetCacheSize方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
	return TRUE;
}
...
BOOL CAdoRecordSet::SetAbsolutePage(int nPage)
{
	...
	{
		XTRACE(_T("Warning: SetAbsolutePage 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePage()
{
	...
	{
		XTRACE(_T("Warning: GetAbsolutePage 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetAbsolutePosition(int nPosition)
{
	...
	{
		XTRACE(_T("Warning: SetAbsolutePosition 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
long CAdoRecordSet::GetAbsolutePosition()
{
	...
	{
		XTRACE(_T("Warning: GetAbsolutePosition 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	}
}
...
BOOL CAdoRecordSet::SetCursorLocation(CursorLocationEnum CursorLocation)
{
	...
	{
		XTRACE(_T("Warning: PutCursorLocation 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
CursorLocationEnum CAdoRecordSet::GetCursorLocation()
{
	...
	{
		XTRACE(_T("Warning: GetCursorLocation 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return adUseNone;
	}
}
...
BOOL CAdoRecordSet::SetCursorType(CursorTypeEnum CursorType)
{
	...
	{
		XTRACE(_T("Warning: SetCursorType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
CursorTypeEnum CAdoRecordSet::GetCursorType()
{
	...
	{
		XTRACE(_T("Warning: GetCursorType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
...
FieldsPtr CAdoRecordSet::GetFields()
{
	...
	{
		XTRACE(_T("Warning: GetFields 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return NULL;
	} 
	return NULL;
}
...
CString CAdoRecordSet::GetFieldName(long lIndex)
{
	...
	{
		XTRACE(_T("Warning: GetFieldName 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
	}
	return strFieldName;
}
...
long CAdoRecordSet::GetFieldAttributes(long lIndex)
{
	...
	{
		XTRACE(_T("Warning: GetFieldAttributes 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldDefineSize(long lIndex)
{
	...
	{
		XTRACE(_T("Warning: GetDefineSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	}
}
...
long CAdoRecordSet::GetFieldActualSize(long lIndex)
{
	...
	{
		XTRACE(_T("Warning: GetFieldActualSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return -1;
	}	
}
...
DataTypeEnum CAdoRecordSet::GetFieldType(long lIndex)
{
	...
	{
		XTRACE(_T("Warning: GetField 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return adEmpty;
	}	
}
...
DataTypeEnum CAdoRecordSet::GetFieldType(LPCTSTR lpszFieldName)
{
	...
	{
		XTRACE(_T("Warning: GetField发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return adEmpty;
	}	
}
...
BOOL CAdoRecordSet::IsFieldNull(LPCTSTR lpFieldName)
{
	...
	{
		XTRACE(_T("Warning: IsFieldNull 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::PutCollect(long index, const _variant_t &value)
{
	...
	{
		XTRACE(_T("Warning: PutCollect 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
	return	FALSE;
}
...
BOOL CAdoRecordSet::PutCollect(long index, const bool &value)
{
	...
	if (GetFieldType(index) != adBoolean)
		XTRACE(_T("Warning: 你要存贮的字段与变量的数据类型不符; 文件: %s; 行: %d\n"), _T(__FILE__), __LINE__);
	#endif
...
BOOL CAdoRecordSet::GetCollect(LPCTSTR strFieldName,  __int64 &value)
{
	ASSERT(m_pRecordset != NULL);

	try
	{
		value = vartoi64(m_pRecordset->GetCollect(_variant_t(strFieldName)));
		return TRUE;
	}
	catch (_com_error e)
	{
...
BOOL CAdoRecordSet::GetCollect(long index, CString& strValue)
{
	...
	{
		XTRACE(_T("Warning: 字段访问失败. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
...
BOOL CAdoRecordSet::AppendChunk(FieldPtr pField, LPVOID lpData, UINT nBytes)
{
	...
	{
		XTRACE(_T("Warning: AppendChunk 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::GetChunk(FieldPtr pField, LPVOID lpData)
{
	...
	{ 
		...
		{
			XTRACE(_T("Warning: GetChunk 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
			return FALSE;
		}
	}
...
BOOL CAdoRecordSet::Supports(CursorOptionEnum CursorOptions)
{
	...
	{
		XTRACE(_T("Warning: Supports方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::SetFilter(LPCTSTR lpszFilter)
{
	...
	{
		XTRACE(_T("Warning: SetFilter 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
_variant_t CAdoRecordSet::GetBookmark()
{
	...
	{
		XTRACE(_T("Warning: GetBookmark 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
	}
...
BOOL CAdoRecordSet::SetBookmark(_variant_t varBookMark)
{
	...
	{
		XTRACE(_T("Warning: SetBookmark 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
	}
	return FALSE;
}
...
BOOL CAdoRecordSet::Clone(CAdoRecordSet &pRecordSet)
{
	...
	{
		XTRACE(_T("Warning: Clone 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::Find(LPCTSTR lpszFind, SearchDirectionEnum SearchDirection)
{
	...
	{
		XTRACE(_T("Warning: Find 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::FindNext()
{
	...
	{
		XTRACE(_T("Warning: FindNext 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoRecordSet::RecordBinding(CADORecordBinding &pAdoRecordBinding)
{
	...
	{
		XTRACE(_T("Warning: RecordBinding 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
