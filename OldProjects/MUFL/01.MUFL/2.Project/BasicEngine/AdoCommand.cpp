...
void CAdoCommand::Release()
{
	...
	{
		XTRACE(_T("Warning: Release方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
	} 
}
...
_RecordsetPtr CAdoCommand::Execute(long Options)
{
	...
	{
		XTRACE(_T("Warning: Execute 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return NULL;
	} 
}
...
BOOL CAdoCommand::Cancel()
{
	...
	{
		XTRACE(_T("Warning: Cancel 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
}
								  ...
								  _variant_t Value)
{
	...
	{
		XTRACE(_T("Warning: CreateParameter 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return NULL;
	} 
}
...
BOOL CAdoCommand::SetCommandText(LPCTSTR lpstrCommand)
{
	...
	{
		XTRACE(_T("Warning: PutCommandText 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::SetConnection(CAdoConnection *pConnect)
{
	...
	{
		XTRACE(_T("Warning: SetConnection 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
}
/*========================================================================
...
BOOL CAdoCommand::SetCommandType(CommandTypeEnum CommandType)
{
	...
	{
		XTRACE(_T("Warning: PutCommandType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::SetCommandTimeOut(long lTime)
{
	...
	{
		XTRACE(_T("Warning: SetCommandTimeOut 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
}
...
BOOL CAdoCommand::Append(_ParameterPtr param)
{
	...
	{
		XTRACE(_T("Warning: Append 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	} 
}
...
_ParameterPtr CAdoCommand::GetParamter(LPCTSTR lpstrName)
{
	...
	{
		XTRACE(_T("Warning: GetParamter 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return NULL;
	} 
}
...
_variant_t CAdoCommand::GetValue(long index)
{
	...
	{
		XTRACE(_T("Warning: GetValue 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		_variant_t vt;
		vt.vt = VT_NULL;
		return vt;
	} 
...
CAdoParameter CAdoCommand::operator [](int index)
{
	...
	{
		XTRACE(_T("Warning: operator [] 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
	}
	return pParameter;
}
...
BOOL CAdoParameter::SetPrecision(char nPrecision)
{
	...
	{
		XTRACE(_T("Warning: SetPrecision 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
...
BOOL CAdoParameter::SetType(DataTypeEnum DataType)
{
	...
	{
		XTRACE(_T("Warning: SetType 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}	
}
...
DataTypeEnum CAdoParameter::GetType()
{
	...
	{
		XTRACE(_T("Warning: SetDirection 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return adEmpty;
	}
}
...
BOOL CAdoParameter::SetSize(int size)
{
	...
	{
		XTRACE(_T("Warning: SetSize 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}	
}
...
BOOL CAdoParameter::SetName(CString strName)
{
	...
	{
		XTRACE(_T("Warning: SetName 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}	
}
...
BOOL CAdoParameter::SetValue(const bool &value)
{
	...
	{
		XTRACE(_T("Warning: SetValue 方法发生异常. 错误信息: %s; 文件: %s; 行: %d\n"), e.ErrorMessage(), _T(__FILE__), __LINE__);
		return FALSE;
	}
}
