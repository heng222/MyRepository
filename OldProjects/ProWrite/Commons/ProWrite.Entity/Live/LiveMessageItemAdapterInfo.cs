...
{
    [Serializable]
    public class LiveMessageItemAdapterInfo:LiveAdapter
    {
        ...
        public LiveMessageItemAdapterInfo()
		{
		}

        public LiveMessageItemAdapterInfo(LiveMessageItem message)
            : base(message)
		{
		}
		...
		{
            get { return base.Target as LiveMessageItem; }
		}
		...
		{
            get { return LiveType.LiveMessageProxy; }
		}
        ...
        {
            return new LiveMessageItemAdapterInfo();
        }
        ...
        {
            LiveMessageItemAdapterInfo clone = new LiveMessageItemAdapterInfo();
            clone.FromTo(this);
            return clone;
            //return base.Copy();
        }
        ...
        public override void FromTo(LiveAdapter item)
        {
            ...
            if (item != null)
            {
                base.FromTo(item);
                //TODO:
                InternalFromTo(item as LiveMessageItemAdapterInfo);
            }
        }
        ...
        private void InternalFromTo(LiveAdapter item)
        {
            ...
            if (item != null)
            {
                this.IsActive = (item as LiveMessageItemAdapterInfo).IsActive;                
            }
        }
    }
}
