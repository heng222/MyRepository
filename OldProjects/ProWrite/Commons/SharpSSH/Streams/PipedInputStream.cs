...
//			int i = 0;
        ...
        //warning CS0114: 'Tamir.Streams.PipedInputStream.read()' hides inherited member 'Tamir.SharpSsh.java.io.InputStream.read()'. To make the current member override that implementation, add the override keyword. Otherwise add the new keyword.
        
        public new virtual int read()  
		{
			if (!connected) 
			{
				throw new IOException("Pipe not connected");
