	...
	public class Session : Runnable
	{
		...
		public void connect(int connectTimeout) 
		{
			...
			if(random==null)
			{
				try
				{
					random = new Tamir.SharpSsh.jsch.jce.Random();
				}
				catch(Exception e)
				{
...
//			loop:
		...
		private void send_kexinit()  
		{
            ...
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_kex));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_server_host_key));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_cipher_c2s));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_cipher_s2c));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_mac_c2s));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_mac_s2c));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_compression_c2s));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_compression_s2c));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_lang_c2s));
            buf.putString(System.Text.Encoding.UTF8.GetBytes(Properties.Resources.kexinit_lang_s2c));
			buf.putByte((byte)0);
			buf.putInt(0);
