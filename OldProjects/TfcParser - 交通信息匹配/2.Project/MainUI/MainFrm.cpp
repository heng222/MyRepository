...
void CMainFrame::ActiveEvents()
{
    ...
    // 
    CMainUIView* pRoadView = (CMainUIView*)(theApp.GetView(RUNTIME_CLASS(CMainUIView)));
    TImcMsg msg1(EMSG_CREATE_TFCRAWVIEW,ID_MODULE_USERIF,ID_MODULE_DATABASE);
    msg1.m_wParam = (WPARAM)pRoadView;
