...
BOOL CChildFrame::OnCreateClient(LPCREATESTRUCT lpcs, CCreateContext* pContext)
{
    ...
    //VERIFY(m_HSplitter.CreateView(0,0,RUNTIME_CLASS(CMainUIView),CSize(100,500),pContext));
    //VERIFY(m_HSplitter.CreateView(1,0,RUNTIME_CLASS(CLogView),CSize(100,100),pContext));
    ...
    VERIFY(m_VSplitter.CreateView(0,0,RUNTIME_CLASS(CMainUIView),CSize(500,600),pContext));
    VERIFY(m_VSplitter.CreateView(0,1,RUNTIME_CLASS(CParsedTfcView),CSize(500,600),pContext));
